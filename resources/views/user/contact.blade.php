...
<body>
    ...
    <div class="flex-shrink-0 ul-search-form-wrapper flex-grow-1">
            ...
            <div class="ul-header-bottom">
                <div class="ul-header-bottom-wrapper ul-header-container">
                    <div class="logo-container">
                        <a href="index.html" class="d-inline-block"><img src="assets/img/logo-dark.svg" alt="logo"
                                class="logo" /></a>
                    </div>
    ...
    <main>
        ...
        <section class="ul-section-spacing">
            <div class="ul-inner-contact-container">
                <div
                    class="row g-lg-4 g-3 row-cols-lg-4 row-cols-md-3 row-cols-2 row-cols-xxs-1 justify-content-center">
                    <!-- single contact info -->
                    <div class="col">
                ...
                <div class="pb-0 ul-section-spacing">
                    <div class="row gy-5 row-cols-lg-2 row-cols-1 align-items-center flex-column-reverse flex-lg-row">
                        <!-- img -->
                        <div class="col">
                            <div>
                                <div class="text-center ul-inner-contact-img">
                                    <img src="assets/img/contact-img.jpg" alt="Image" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col">
                            <div class="ul-inner-contact-form-wrapper">
                                <h3 class="ul-inner-contact-form-title">Get in Touch</h3>

                                <form action="#" class="ul-inner-contact-form">
                                    <div class="row g-lg-4 g-3 row-cols-sm-2">
                                        <div>
                                            <input type="text" name="ul-contact-name" id="ul-contact-name"
                                                placeholder="Full Name" />
                                        </div>
                                        <div>
                                            <input type="email" name="ul-contact-email" id="ul-contact-email"
                                                placeholder="Email Address" />
                                        </div>
                                        <div>
                                            <input type="tel" name="ul-contact-phone" id="ul-contact-phone"
                                        ...
                                        <div class="col-sm-12 col-12">
                                            <textarea name="ul-contact-message" id="ul-contact-message" placeholder="Messages"></textarea>
                                        </div>
                                    </div>
                                    <div class="ul-checkout-agreement-wrapper">
                                        <label for="ul-checkout-agreement">
                                            <input type="checkbox" name="ul-checkout-agreement"
                                                id="ul-checkout-agreement" hidden="" checked="" />
                                            <span class="txt">Collaboratively formulate principle capital.
