    ...
    <main>
      ...
      <section class="ul-foods-shop ul-section-spacing">
        <div class="ul-shop-container">
          <div
            class="row ul-bs-row row-cols-lg-4 row-cols-md-3 row-cols-2 row-cols-xxs-1"
          >
            <!-- single menu item -->
            <div class="col">
              <div class="ul-food">
                <div class="ul-food-img">
                  <img src="assets/img/food-1.png" alt="food Image" />
                </div>
                <div class="ul-food-txt">
                  <a href="shop-details.html" class="ul-food-title"
                    >Egg and Cucumber</a
                  >
                  <p class="ul-food-sub-title">
                    It's the perfect dining experience where a every dish is
                    crafted with fresh high quality
                  </p>
                  <div class="ul-food-bottom">
                    <span class="ul-food-price"
                      ><span class="number">$4,500</span></span
                    >
                    <div class="ul-food-rating">
            ...
            <div class="col">
              <div class="ul-food">
                <div class="ul-food-img">
                  <img src="assets/img/food-2.png" alt="food Image" />
                </div>
                <div class="ul-food-txt">
                  <a href="shop-details.html" class="ul-food-title"
                    >Lunch Foods</a
            ...
            <div class="col">
              <div class="ul-food">
                <div class="ul-food-img">
                  <img src="assets/img/food-3.png" alt="food Image" />
                </div>
                <div class="ul-food-txt">
                  <a href="shop-details.html" class="ul-food-title"
                    >Dinner Foods</a
            ...
            <div class="col">
              <div class="ul-food">
                <div class="ul-food-img">
                  <img src="assets/img/shop-details.png" alt="food Image" />
                </div>
                <div class="ul-food-txt">
                  <a href="shop-details.html" class="ul-food-title"
                    >Desert Foods</a
          ...
          <div class="ul-pagination pt-0 border-0">
            <ul>
              ...
              <li>
                <a href="#"><i class="flaticon-right-arrow-3"></i></a>
              </li>
            </ul>
          </div>
          <!-- PAGINATION END -->
