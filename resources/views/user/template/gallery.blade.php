...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <section class="ul-inner-gallery ul-section-spacing">
        <div class="ul-container wow animate__fadeInUp">
          <div class="row row-cols-md-3 row-cols-2 row-cols-xxs-1 ul-bs-row">
            <div class="col">
              <div class="ul-inner-gallery-item">
                <a
                  href="assets/img/gallery-item-1.jpg"
                  data-fslightbox="gallery"
                  ><i class="flaticon-plus"></i
                ></a>
                <img src="assets/img/gallery-item-1.jpg" alt="Image" />
              </div>
              <div class="ul-inner-gallery-item">
                <a
                  href="assets/img/gallery-item-2.jpg"
                  data-fslightbox="gallery"
                  ><i class="flaticon-plus"></i
                ></a>
                <img src="assets/img/gallery-item-2.jpg" alt="Image" />
              </div>
            </div>
            <div class="col">
              <div class="ul-inner-gallery-item">
                <a
                  href="assets/img/gallery-item-3.jpg"
                  data-fslightbox="gallery"
                  ><i class="flaticon-plus"></i
                ></a>
                <img src="assets/img/gallery-item-3.jpg" alt="Image" />
              </div>
              <div class="ul-inner-gallery-item">
                <a
                  href="assets/img/gallery-item-4.jpg"
                  data-fslightbox="gallery"
                  ><i class="flaticon-plus"></i
                ></a>
                <img src="assets/img/gallery-item-4.jpg" alt="Image" />
              </div>
            </div>
            ...
            <div class="col">
              <div class="ul-inner-gallery-item">
                <a
                  href="assets/img/gallery-item-5.jpg"
                  data-fslightbox="gallery"
                  ><i class="flaticon-plus"></i
                ></a>
                <img src="assets/img/gallery-item-5.jpg" alt="Image" />
              </div>
            </div>
          </div>
        </div>
