    ...
    <main>
      ...
      <section class="ul-section-spacing">
        <div class="ul-inner-contact-container">
          ...
          <div class="ul-section-spacing pb-0">
            <div
              class="row gy-5 row-cols-lg-2 row-cols-1 align-items-center flex-column-reverse flex-lg-row"
            >
              <!-- img -->
              <div class="col">
                <div>
                  <div class="ul-inner-contact-img text-center">
                  ...
                  <form action="#" class="ul-inner-contact-form">
                    ...
                    <div class="ul-checkout-agreement-wrapper">
                      <label for="ul-checkout-agreement">
                        <input
                          type="checkbox"
                          name="ul-checkout-agreement"
                          id="ul-checkout-agreement"
                          hidden=""
                          checked=""
                        />
                        <span class="txt"
