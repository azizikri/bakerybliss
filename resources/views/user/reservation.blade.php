...
<html lang="en">
  <head>
    ...
    <title>Shared on THEMELOCK.COM - Document</title>
          ...
          <div class="ul-header-container">
            <div class="ul-header-top-left">
              <div class="ul-header-contact-infos">
                <span class="ul-header-contact-info"
                  ><i class="flaticon-location-pin colored"></i> Rd. Santa Ana,
        ...
        <div class="ul-header-bottom">
          <div class="ul-header-bottom-wrapper ul-header-container">
            ...
            <div class="ul-header-actions">
              ...
              <a href="shop.html" class="ul-btn d-sm-inline-flex d-none"
                >order now <i class="flaticon-right"></i
              ></a>
    ...
    <main>
      ...
      <div class="ul-breadcrumb">
        <div class="wow animate__fadeInUp">
          <h2 class="ul-breadcrumb-title">Reservation</h2>
          <div class="ul-breadcrumb-nav">
            <a href="index.html">Home</a>
            <span class="separator">/</span>
            <span class="current-page">Reservation</span>
          </div>
        </div>
      </div>
      ...
      <section class="ul-discount ul-section-spacing">
        <div class="ul-container wow animate__fadeInUp">
          <div class="row g-4">
            <!-- txt -->
            <div class="col-md-5">
              <div class="ul-discount-txt">
                <span class="ul-section-sub-title ul-section-sub-title--2"
                  ><i class="flaticon-tray"></i> Enjoy Our Dishes
                  <i class="flaticon-tray"></i
                ></span>
                <h2 class="ul-section-title">
                  We serve and deliver delectable food.
                </h2>
                <span class="ul-discount-second-title"
                  >What Are The Restaurant's Operating Hours?</span
                >
                <p class="ul-section-descr">
                  It is a long established fact that a reader will be distracted
                  lorem the readable content of a page when looking
                </p>
                <div class="ul-discount-countdown">
                  <h3 class="ul-discount-countdown-title">
                    Get Discount Every Item
                  </h3>
                  <div class="ul-countdown">
                    <div class="ul-countdown-item">
                      <span class="number days">20</span>
                      <span class="label">Days</span>
                    </div>
                    <div class="ul-countdown-item">
                      <span class="number hours">48</span>
                      <span class="label">hrs</span>
                    </div>
                    <div class="ul-countdown-item">
                      <span class="number minutes">16</span>
                      <span class="label">mins</span>
                    </div>
                    <div class="ul-countdown-item">
                      <span class="number seconds">38</span>
                      <span class="label">secs</span>
                    </div>
                  </div>
                </div>
                <a href="#" class="ul-btn ul-btn--2"
                  >Order Now <i class="flaticon-right"></i
                ></a>
              </div>
            </div>
            ...
            <!-- image -->
            <div class="col-md-7">
              <div class="ul-discount-img">
                <img
                  src="assets/img/discount-img.jpg"
                  alt="Image"
                  class="main-img"
                />
                <img
                  src="assets/img/discount-product-img.png"
                  alt="Discount Product"
                  class="ul-discount-product-img"
                />
                <img
                  src="assets/img/discount-sticker.png"
        ...
        <!-- vector -->
        <img
          src="assets/img/discount-vector.png"
          alt="Vector Image"
          class="ul-discount-vector wow animate__fadeInRight"
        />
      </section>
      <!-- DISCOUNT SECTION END -->

      <!-- BOOKING SECTION START -->
      <section class="ul-booking-2 ul-section-spacing">
            ...
            <div class="row g-0">
                ...
                <div class="ul-booking-2-form-wrapper">
                  <div class="ul-booking-2-form-heading">
                    <span class="ul-section-sub-title"
                      ><i class="flaticon-tray"></i> Book your seat
                      <i class="flaticon-tray"></i
                    ></span>
                    <h2 class="ul-section-title">
                  ...
                  <form action="#" class="ul-booking-2-form">
                    <div class="row g-3">
                      ...
                      <div class="col-6 col-xxs-12">
                        <select name="guest" id="booking-guest-select">
                          <option data-placeholder="true">Guest</option>
              ...
              <div class="col-md-5">
                <div class="ul-booking-2-opening-time">
                  <div class="heading">
                    <span class="ul-section-sub-title"
                      ><i class="flaticon-tray"></i> Reservation
                      <i class="flaticon-tray"></i
                    ></span>
                    <h2 class="ul-section-title">Opening Time</h2>
                    <img
                      src="assets/img/time-vector.svg"
                      alt="vector"
                      class="ul-booking-2-vector"
                    />
                  </div>

                  <table class="ul-booking-2-opening-time-table">
                    <thead>
                      <tr>
                        <th>MONDAY TO FRIDAY</th>
                        <th>FRIDAY TO SUNDAY</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                  ...
                  <a
                    href="tel:1303404608"
                    class="ul-section-title ul-booking-2-opening-time-call"
                    >+1 303 404 608</a
                  >
                </div>
              </div>
      ...
      <section class="ul-inner-sub-banners ul-section-spacing">
        <div class="ul-inner-sub-banners-container">
          <div class="row row-cols-xl-3 row-cols-md-2 row-cols-1 ul-bs-row">
            <!-- single card -->
            <div class="col">
              <div class="ul-inner-sub-banner">
                <div class="ul-inner-sub-banner-txt">
                  <span class="ul-inner-sub-banner-sub-title"
                    >Start Price $25</span
                  >
                  <h4 class="ul-inner-sub-banner-title">Today Spacial Food</h4>
                  <p class="ul-inner-sub-banner-descr">Limits Time Offer</p>
                  <a href="shop.html" class="ul-inner-sub-banner-btn"
                    >Order Now <i class="flaticon-right"></i
                  ></a>
                </div>
                <div class="ul-inner-sub-banner-img">
                  <img
                    src="assets/img/sub-banner-1-img.png"
                    alt="Image"
                    class="main-img"
                  />
                  <img
                    src="assets/img/sub-banner-img-vector-1.png"
                    alt="vector"
                    class="vector-1"
                  />
                  <img
                    src="assets/img/discount-2-vector.png"
                    alt="vector"
                    class="vector-2"
                  />
                </div>
                <!-- vector -->
                <img
                  src="assets/img/inner-cta-vector-1.png"
                  alt="Vector"
                  class="ul-inner-sub-banner-vector"
                />
              </div>
            </div>
            ...
            <!-- single card -->
            <div class="col">
              <div class="ul-inner-sub-banner ul-inner-sub-banner--2">
                <div class="ul-inner-sub-banner-txt">
                  <span class="ul-inner-sub-banner-sub-title"
                    >Start Price $25</span
                  >
                ...
                <div class="ul-inner-sub-banner-img">
                  <img
                    src="assets/img/sub-banner-2-img.png"
                    alt="Image"
                    class="main-img"
                  />
                  <img
            ...
            <!-- single card -->
            <div class="col">
              <div class="ul-inner-sub-banner ul-inner-sub-banner--3">
                <div class="ul-inner-sub-banner-txt">
                  <span class="ul-inner-sub-banner-sub-title"
                    >Start Price $25</span
                  >
                ...
                <div class="ul-inner-sub-banner-img">
                  <img
                    src="assets/img/sub-banner-3-img.png"
                    alt="Image"
                    class="main-img"
                  />
                  <img
    ...
    <footer class="ul-footer">
      <div class="ul-footer-top">
          ...
          <div class="ul-footer-top-wrapper wow animate__fadeInUp">
            ...
            <div class="ul-footer-widget ul-nwsltr-widget">
              ...
              <div class="ul-footer-widget-links">
                <span
                  >Monday - Friday :
                  <span class="colored">8am - 4pm</span></span
                >
        ...
        <div class="ul-footer-vectors">
          ...
          />
          <img
            src="assets/img/footer-vector-3.svg"
            alt="Footer Image"
            class="ul-footer-vector-3"
          />
        </div>
      </div>
