            ...
            <div class="col">
              <div class="form-group">
                <label for="ul-checkout-different-address-field"
                  >Shift to A Different Address</label
                >
                <textarea
              ...
              <div class="ul-checkout-payment-methods">
                ...
                <button type="submit" class="ul-checkout-form-btn">
                  Place Your Order
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="ul-checkout-bill-summary-body">
                <div class="single-row">
                  <span class="left">Pain Relievers</span
              ...
              <div
                class="ul-checkout-bill-summary-footer ul-checkout-bill-summary-header"
              >
