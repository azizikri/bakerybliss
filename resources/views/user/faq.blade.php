...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <!-- FAQ SECTION START -->
      <section class="ul-section-spacing ul-inner-faq">
        <div class="ul-container">
          <div
            class="row gx-0 gy-4 justify-content-between flex-column-reverse flex-md-row"
          >
            <!-- img -->
            <div class="col-lg-5 col-md-5">
              <div class="ul-inner-faq-imgs">
                <img src="assets/img/faq-img-1.jpg" alt="Image" />
                <img src="assets/img/faq-img-2.jpg" alt="Image" />
              </div>
            </div>

            <!-- txt -->
            <div class="col-lg-6 col-md-7">
              <div class="ul-inner-faq-txt">
                <span class="ul-section-sub-title">FAQs</span>
                <h2 class="ul-section-title">
                  Get Every Single Answer From Here
                </h2>

                <div class="ul-inner-faq-list">
                  <div class="ul-accordion">
                    <div class="ul-single-accordion-item">
                      <div class="ul-single-accordion-item__header">
                        <div class="left">
                          <h3 class="ul-single-accordion-item__title">
                      ...
                      <div class="ul-single-accordion-item__body">
                        <p>
                          Aonsectetur adipiscing elit Aenean scelerisque augue
                          vitae consequat Juisque eget congue velit in cursus
                          leo sodales the turpis euismod quis sapien euismod
                          quis sapien the. E-learning is suitable for students,
