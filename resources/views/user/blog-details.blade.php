            ...
            <div class="col-lg-8 col-md-7">
              <div class="ul-blog-details ul-blog-inner mb-0">
                ...
                <div class="ul-blog-txt">
                  ...
                  <h3 class="ul-blog-details-title">
                    Supervisor Disapproved of Latest Work
                  </h3>
                  <p class="ul-blog-details-descr">
                ...
                <div class="ul-blog-details-bottom">
                    ...
                    <div class="ul-blog-details-review">
                      ...
                      <div class="ul-blog-details-review-txt">
                        <div class="header">
                          ...
                          <div class="right">
                            <button class="ul-blog-details-review-reply-btn">
                              Reply
                            </button>
                          </div>
                        </div>
                        ...
                        <p>
                          ...
                          felis id, eleifend turpis. Phasellus in nulla quis
                          erat tempor tristique eget vel purus. Nulla pharetra
                          ...
                          arcu ultricies sapien. Quisque ut dapibus nunc.
                          Vivamus sit amet efficitur velit. Phasellus eget
                  ...
                  <div class="ul-blog-details-review-form-wrapper">
                    <h3
                      class="ul-blog-details-inner-title ul-blog-details-comment-form-title"
                    >
                      Leave a Comment
                    </h3>
                    ...
                    <form class="ul-blog-details-review-form">
                      ...
                      <div class="form-group">
                        <button type="submit" class="ul-btn">
                          Post a Comment <i class="flaticon-right"></i>
                        </button>
                      </div>
                    </form>
                  </div>
            ...
            <div class="col-lg-4 col-md-5">
              <div class="ul-blog-sidebar">
                ...
                <div class="ul-blog-sidebar-widget ul-blog-sidebar-search">
                  <h3
                    class="ul-blog-sidebar-widget-title ul-service-details-sidebar-widget-title"
                  >
                    Search
                  </h3>
                ...
                <div class="ul-blog-sidebar-widget categories">
                  ...
                  <div class="ul-blog-sidebar-widget-content">
                    <div class="ul-blog-sidebar-categories">
                      <a href="blog.html"
                        >Product Presentation <span>(08)</span></a
                      >
                      <a href="blog.html"
                        >Dedicated Video Call <span>(11)</span></a
                      >
                      <a href="blog.html"
                        >Trending Challenge <span>(18)</span></a
                      >
                        ...
                        <div class="txt">
                          ...
                          <h4 class="title">
                            <a href="blog-details.html"
                              >There are many vario ns of passages of</a
                            >
                          </h4>
                        </div>
                      </div>
